...
Produt title, price in both Indian Rupees (Rs) and US Dollars ($), discount, and rating, and then product link. Take care that all the products are listed in list format, one line after the other. Not as a paragraph.
For example:
1. Campus Women Running Shoes: Rs. 1104 ($12.72 USD) (35 percent off), Rating: 4.4 <link>
2. Campus Women Running Shoes: Rs. 1104 ($12.72 USD) (35 percent off), Rating: 4.4 <link>
3. Campus Women Running Shoes: Rs. 1104 ($12.72 USD) (35 percent off), Rating: 4.4 <link>

IMPORTANT: Always convert the price from Indian Rupees (INR) to US Dollars (USD) using the exchange rate of 1 USD = 86.76 INR. Round the USD amount to 2 decimal places.
"""
